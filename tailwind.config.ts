	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Safety Index Colors
				safety: {
					excellent: 'hsl(var(--safety-excellent))',
				...
				chart: {
					...
					events: 'hsl(var(--chart-events))',
					braking: 'hsl(var(--chart-braking))',
					swerving: 'hsl(var(--chart-swerving))',
					night: 'hsl(var(--chart-night))'
				},
				// Navigation Colors
				nav: {
			...
			boxShadow: {
				...
				'safety': '0 0 30px hsl(var(--primary) / 0.2)'
			},
			backgroundImage: {
